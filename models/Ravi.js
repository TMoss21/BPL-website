...
exports.updateSchema = async function(gameweek){
	...
	const oldteam = await picks.getNewTeam("Jaspal", gameweek);
	const newteam = await picks.getOldTeam("Jaspal", gameweek);
	...
	const newJaspal = new Jaspal({
		gameweek: gameweek,
		gameweekPoints: picks.getGWPoints("Jaspal", gameweek),
		totalPoints: picks.getTotalPoints("Jaspal", gameweek),
		transfersIn: newPlayers,
		transfersOut: oldPlayers,
		pointsSpent: picks.getPointsSpent("Jaspal", gameweek),
		chipsUsed: picks.getChipUsed("Jaspal", gameweek),
		bank: picks.getBank("Jaspal", gameweek),
		overallRank: picks.getOverallRank("Jaspal", gameweek),
	});
