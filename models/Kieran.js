...
exports.updateSchema = async function(gameweek){
	...
	const oldteam = await picks.getNewTeam("Aggarwal", gameweek);
	const newteam = await picks.getOldTeam("Aggarwal", gameweek);
	...
	const newAggarwal = new Aggarwal({
		gameweek: gameweek,
		gameweekPoints: picks.getGWPoints("Aggarwal", gameweek),
		totalPoints: picks.getTotalPoints("Aggarwal", gameweek),
		transfersIn: newPlayers,
		transfersOut: oldPlayers,
		pointsSpent: picks.getPointsSpent("Aggarwal", gameweek),
		chipsUsed: picks.getChipUsed("Aggarwal", gameweek),
		bank: picks.getBank("Aggarwal", gameweek),
		overallRank: picks.getOverallRank("Aggarwal", gameweek),
	});
